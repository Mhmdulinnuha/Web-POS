...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
        ...
        @for ($i = 1; $i <= 12; $i++)
        <div class="group bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 p-4 shadow-sm hover:shadow-xl hover:border-yellow-400 dark:hover:border-yellow-400 transition-all cursor-pointer transform hover:-translate-y-1">
            <div class="aspect-square bg-gray-50 dark:bg-slate-900 rounded-xl mb-3 flex items-center justify-center overflow-hidden">
                <i class="fas fa-box text-3xl text-gray-300 group-hover:text-[#0d47a1] dark:group-hover:text-yellow-400 transition-colors"></i>
            </div>
            
            <div class="space-y-1">
                <h4 class="font-bold text-gray-800 dark:text-white text-sm line-clamp-2 leading-tight">Produk Contoh #{{ $i }}</h4>
                <p class="text-[10px] text-gray-400 uppercase font-semibold">Kategori</p>
                <div class="flex justify-between items-center pt-2">
                    <span class="text-[#0d47a1] dark:text-yellow-400 font-black text-sm">Rp 25.000</span>
                    <button class="w-8 h-8 bg-gray-100 dark:bg-slate-700 group-hover:bg-yellow-400 group-hover:text-[#0d47a1] rounded-lg flex items-center justify-center transition-colors">
